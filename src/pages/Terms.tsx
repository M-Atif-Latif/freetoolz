    ...
    <div className="max-w-4xl mx-auto px-4 py-12">
      ...
      <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8 prose max-w-none">
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700 space-y-2 ml-4">
          ...
          <li>Not upload or process illegal, harmful, or offensive content</li>
          <li>Verify important results before making critical decisions</li>
          <li>Respect intellectual property rights when using generated content</li>
          <li>Not attempt to exploit or abuse the service</li>
        </ul>

        <h2 className="text-2xl font-bold mb-3 mt-8 text-gray-800">⚖️ Disclaimer of Warranties</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          The tools and services are provided "as is" and "as available" without any warranties of any kind, 
          either express or implied. We do not guarantee that the service will be uninterrupted, secure, or error-free. 
          We make no warranties about the accuracy, reliability, or completeness of any content or results.
        </p>
        ...
        <ul className="list-disc list-inside mb-4 text-gray-700 space-y-2 ml-4">
          ...
          <li>Any errors or inaccuracies in the tools' results</li>
          <li>Any unauthorized access to your data</li>
          <li>Any interruption or cessation of the service</li>
        </ul>

        <h2 className="text-2xl font-bold mb-3 mt-8 text-gray-800">🔄 Service Modifications</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
          We reserve the right to modify, suspend, or discontinue any part of the service at any time without 
          prior notice. We may also update these Terms of Service periodically. Continued use of the service 
          after changes constitutes acceptance of the new terms.
        </p>

        <h2 className="text-2xl font-bold mb-3 mt-8 text-gray-800">📚 Intellectual Property</h2>
        <p className="mb-4 text-gray-700 leading-relaxed">
