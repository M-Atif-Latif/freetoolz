      ...
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8">
        ...
        <div className="mb-6">
          ...
          <textarea
            ...
            className="w-full h-64 px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white font-mono text-sm resize-none focus:border-primary-500 focus:ring focus:ring-primary-200"
          />
        </div>
