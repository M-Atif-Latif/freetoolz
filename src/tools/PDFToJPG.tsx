          ...
          <>
            ...
            <div className="mb-6">
              ...
              <select
                ...
                className="w-full px-4 py-3 border-2 border-gray-200 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white focus:border-primary-500 focus:ring focus:ring-primary-200 dark:focus:ring-blue-800 outline-none"
              >
            ...
            <button
              ...
              disabled={processing}
              className="w-full px-6 py-4 bg-accent-600 text-white rounded-lg hover:bg-accent-700 transition-colors font-semibold text-lg shadow-lg disabled:bg-gray-400 disabled:cursor-not-allowed"
            >
